    ...
    internal static class GUIElements
    {
        ...
        public static bool Header(GUIContent title, SerializedProperty expanded, SerializedProperty enabled = null, PropertyInfo enabledProp = null)
        {
            ...
            if (e.type == EventType.Repaint) {
                if (enabled == null) {
                    HeaderFoldout.Draw(foldoutRect, false, false, display, false);
                } else {
                    HeaderCheckbox.Draw(foldoutRect, false, false, enabled.boolValue, false);
                }
            }
            ...
            if (e.type == EventType.MouseDown) {
                if (enabled != null) {
                    ...
                    if (foldoutRect.Contains(e.mousePosition)) {
                        ...
                        if (enabledProp != null) {
                            enabledProp.SetValue(enabled.serializedObject.targetObject, enabled.boolValue, null);
                        }
