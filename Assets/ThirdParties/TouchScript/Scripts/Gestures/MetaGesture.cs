...
namespace TouchScript.Gestures
{
    ...
    public sealed class MetaGesture : Gesture
    {
        ...
        protected override void pointersUpdated(IList<Pointer> pointers)
        {
            ...
            if (UseSendMessage && SendMessageTarget != null) {
                for (var i = 0; i < length; i++) {
                    SendMessageTarget.SendMessage(POINTER_MOVED_MESSAGE, pointers[i], SendMessageOptions.DontRequireReceiver);
                }
            }
        ...
        protected override void pointersReleased(IList<Pointer> pointers)
        {
            ...
            if ((State == GestureState.Began || State == GestureState.Changed) && NumPointers == 0) {
            ...
            if (UseSendMessage && SendMessageTarget != null) {
                for (var i = 0; i < length; i++) {
                    SendMessageTarget.SendMessage(POINTER_RELEASED_MESSAGE, pointers[i], SendMessageOptions.DontRequireReceiver);
                }
            }
        ...
        protected override void pointersCancelled(IList<Pointer> pointers)
        {
            ...
            if (UseSendMessage && SendMessageTarget != null) {
                for (var i = 0; i < length; i++) {
                    SendMessageTarget.SendMessage(POINTER_CANCELLED_MESSAGE, pointers[i], SendMessageOptions.DontRequireReceiver);
                }
            }
