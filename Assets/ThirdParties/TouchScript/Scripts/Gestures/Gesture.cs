...
namespace TouchScript.Gestures
{
    ...
    public abstract class Gesture : DebuggableMonoBehaviour
    {
        ...
        {
            get {
                return sendStateChangeMessages;
            }
            set {
                sendStateChangeMessages = value;
            }
        }
        ...
        {
            get {
                return sendStateChangeEvents;
            }
            set {
                sendStateChangeEvents = value;
            }
        }
        ...
        public GestureState State
        {
            ...
            private set {
                ...
                if (useUnityEvents && sendStateChangeEvents) {
        ...
        public virtual Vector2 ScreenPosition
        {
            get {
                if (NumPointers == 0) {
                    if (!TouchManager.IsInvalidPosition(cachedScreenPosition)) {
        ...
        public Vector2 NormalizedScreenPosition
        {
            get {
                ...
                if (TouchManager.IsInvalidPosition(position)) {
                    return TouchManager.INVALID_POSITION;
                }
        ...
        public IGestureDelegate Delegate
        {
            get;
            set;
        }
        ...
        /// </summary>
        protected PointersNumState pointersNumState
        {
            get;
            private set;
        }
        ...
        public void Cancel(bool cancelPointers, bool returnPointers)
        {
            ...
            for (var i = 0; i < numPointers; i++) {
                touchManager.CancelPointer(activePointers[i].Id, returnPointers);
            }
        }
        ...
        internal void INTERNAL_PointersPressed(IList<Pointer> pointers)
        {
            ...
            if (minPointers <= 0) {
                ...
                if (numPointers == 0) {
                    pointersNumState = PointersNumState.PassedMinThreshold;
                }
            } else {
                if (numPointers < minPointers) {
                    // had < MinPointers, got >= MinPointers
                    if (total >= minPointers) {
                        pointersNumState = PointersNumState.PassedMinThreshold;
                    } else {
                        pointersNumState = PointersNumState.TooFew;
                    }
                ...
                if (numPointers <= maxPointers) {
                    if (total > maxPointers) {
                        ...
                        // this event we crossed MaxPointers
                            ...
                            pointersNumState = PointersNumState.PassedMaxThreshold;
                        }
                    }
                }
                // last event we already were over MaxPointers
                else {
                    pointersNumState = PointersNumState.TooMany;
                }
            }

            if (state == GestureState.Began || state == GestureState.Changed) {
                for (var i = 0; i < count; i++) {
                    pointers[i].INTERNAL_Retain();
                }
            }
        ...
        internal void INTERNAL_PointersUpdated(IList<Pointer> pointers)
        {
            ...
            if (minPointers > 0 && numPointers < minPointers) {
                pointersNumState = PointersNumState.TooFew;
            }

            if (maxPointers > 0 && pointersNumState == PointersNumState.InRange && numPointers > maxPointers) {
                pointersNumState = PointersNumState.TooMany;
            }
        ...
        internal void INTERNAL_PointersReleased(IList<Pointer> pointers)
        {
            ...
            for (var i = 0; i < count; i++) {
                activePointers.Remove(pointers[i]);
            }
        ...
        private void releasePointers(bool cancel)
        {
            ...
            for (var i = 0; i < total; i++) {
                ...
                if (pointer.INTERNAL_Release() == 0 && cancel) {
                    touchManager.CancelPointer(pointer.Id, true);
                }
            }
        }
        ...
        private void registerFriendlyGesture(Gesture gesture)
        {
            ...
            if (!friendlyGestures.Contains(gesture)) {
