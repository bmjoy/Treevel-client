...
namespace TouchScript.Gestures
{
    ...
    public class TapGesture : Gesture
    {
        ...
        {
            get {
                return combinePointersInterval;
            }
            set {
                combinePointersInterval = value;
            }
        }
        ...
        {
            if (!base.ShouldReceivePointer(pointer)) {
                return false;
            }
        ...
        protected override void pointersPressed(IList<Pointer> pointers)
        {
            ...
            if (NumPointers == pointers.Count) {
                ...
                if (tapsDone == 0) {
                    ...
                    if (timeLimit < float.PositiveInfinity) {
                        StartCoroutine("wait");
                    }
