...
namespace TouchScript.Gestures.TransformGestures
{
    ...
    public class TransformGesture : TwoPointTransformGestureBase
    {
        ...
        public Vector3 ProjectionPlaneNormal
        {
            ...
            set {
                if (projection == ProjectionType.Layer) {
                    projection = ProjectionType.Object;
                }

                value.Normalize();

                if (projectionPlaneNormal == value) {
                    return;
                }
        ...
        {
            get {
                return TransformUtils.GlobalToLocalVector(cachedTransform, DeltaPosition);
            }
        }
            ...
            switch (projection) {
                case ProjectionType.Layer:
                    if (projectionLayer == null) {
                        ...
                        transformPlane = new Plane(projectionLayer.WorldProjectionNormal, cachedTransform.position);
                    }
