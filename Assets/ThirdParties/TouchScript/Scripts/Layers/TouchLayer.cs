...
namespace TouchScript.Layers
{
    ...
    public abstract class TouchLayer : MonoBehaviour
    {
        ...
        public ILayerDelegate Delegate
        {
            get;
            set;
        }
        ...
        public virtual HitResult Hit(IPointer pointer, out HitData hit)
        {
            ...
            if (Delegate != null) {
                if (Delegate.ShouldReceivePointer(this, pointer)) {
        ...
        {
            if (!Application.isPlaying || TouchManager.Instance == null) {
                return;
            }
        ...
        internal bool INTERNAL_PressPointer(Pointer pointer)
        {
            ...
            if (pointerPressInvoker != null) {
                pointerPressInvoker.InvokeHandleExceptions(this, new TouchLayerEventArgs(pointer));
            }
