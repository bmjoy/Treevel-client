...
namespace TouchScript.InputSources
{
    ...
    public sealed class StandardInput : InputSource
    {
        ...
        {
            get {
                return emulateSecondMousePointer;
            }
            set {
                emulateSecondMousePointer = value;

                if (mouseHandler != null) {
                    mouseHandler.EmulateSecondMousePointer = value;
                }
            }
        }
...
#pragma warning restore CS0414
        ...
        public override bool UpdateInput()
        {
            ...
            if (windows8PointerHandler != null) {
                ...
                if (mouseHandler != null) {
                    if (handled) {
                        mouseHandler.CancelMousePointer();
                    } else {
                        handled = mouseHandler.UpdateInput();
                    }
                }
        ...
        public override void UpdateResolution()
        {
            ...
            if (windows8PointerHandler != null) {
                windows8PointerHandler.UpdateResolution();
            } else if (windows7PointerHandler != null) {
                windows7PointerHandler.UpdateResolution();
            }
        ...
        protected override void OnEnable()
        {
            ...
            if (CoordinatesRemapper != null) {
                updateCoordinatesRemapper(CoordinatesRemapper);
            }
        }
