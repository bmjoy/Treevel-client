    ...
    public static class PointerUtils
    {
        ...
        public static void ButtonsToString(Pointer.PointerButtonState buttons, StringBuilder builder)
        {
            if ((buttons & Pointer.PointerButtonState.FirstButtonDown) != 0) {
                builder.Append("v");
            } else if ((buttons & Pointer.PointerButtonState.FirstButtonUp) != 0) {
                builder.Append("^");
            } else if ((buttons & Pointer.PointerButtonState.FirstButtonPressed) != 0) {
                builder.Append("1");
            } else {
                builder.Append("_");
            }
            ...
            if ((buttons & Pointer.PointerButtonState.SecondButtonDown) != 0) {
                builder.Append("v");
            } else if ((buttons & Pointer.PointerButtonState.SecondButtonUp) != 0) {
                builder.Append("^");
            } else if ((buttons & Pointer.PointerButtonState.SecondButtonPressed) != 0) {
                builder.Append("2");
            } else {
                builder.Append("_");
            }
            ...
            if ((buttons & Pointer.PointerButtonState.ThirdButtonDown) != 0) {
                builder.Append("v");
            } else if ((buttons & Pointer.PointerButtonState.ThirdButtonUp) != 0) {
                builder.Append("^");
            } else if ((buttons & Pointer.PointerButtonState.ThirdButtonPressed) != 0) {
                builder.Append("3");
            } else {
                builder.Append("_");
            }
            ...
            if ((buttons & Pointer.PointerButtonState.FourthButtonDown) != 0) {
                builder.Append("v");
            } else if ((buttons & Pointer.PointerButtonState.FourthButtonUp) != 0) {
                builder.Append("^");
            } else if ((buttons & Pointer.PointerButtonState.FourthButtonPressed) != 0) {
                builder.Append("4");
            } else {
                builder.Append("_");
            }
            ...
            if ((buttons & Pointer.PointerButtonState.FifthButtonDown) != 0) {
                builder.Append("v");
            } else if ((buttons & Pointer.PointerButtonState.FifthButtonUp) != 0) {
                builder.Append("^");
            } else if ((buttons & Pointer.PointerButtonState.FifthButtonPressed) != 0) {
                builder.Append("5");
            } else {
                builder.Append("_");
            }
