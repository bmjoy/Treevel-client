...
namespace TouchScript
{
    ...
    public sealed class TouchManager : DebuggableMonoBehaviour
    {
        ...
        {
            get {
                return TouchManagerInstance.Instance;
            }
        }
        ...
        public IDisplayDevice DisplayDevice
        {
            get {
                if (Instance == null) {
                    return displayDevice as IDisplayDevice;
                }
        ...
        {
            get {
                return shouldCreateCameraLayer;
            }
            set {
                shouldCreateCameraLayer = value;
            }
        }
        ...
        {
            get {
                return shouldCreateStandardInput;
            }
            set {
                shouldCreateStandardInput = value;
            }
        }
        ...
        public override bool DebugMode
        {
            ...
            set {
                ...
                if (Application.isPlaying) {
                    (Instance as TouchManagerInstance).DebugMode = value;
                }
            }
        }
...
#pragma warning restore CS0414
        ...
        private void Awake()
        {
            ...
            if (DebugMode) {
                (Instance as TouchManagerInstance).DebugMode = true;
            }
            ...
            for (var i = 0; i < layers.Count; i++) {
                ...
                if (layer != null) {
                    LayerManager.Instance.AddLayer(layer, i);
                }
            }
        }
        ...
        private void updateSendMessageSubscription()
        {
            ...
            if ((SendMessageEvents & MessageType.FrameStarted) != 0) {
                Instance.FrameStarted += frameStartedSendMessageHandler;
            }

            if ((SendMessageEvents & MessageType.FrameFinished) != 0) {
                Instance.FrameFinished += frameFinishedSendMessageHandler;
            }

            if ((SendMessageEvents & MessageType.PointersAdded) != 0) {
                Instance.PointersAdded += pointersAddedSendMessageHandler;
            }

            if ((SendMessageEvents & MessageType.PointersUpdated) != 0) {
                Instance.PointersUpdated += pointersUpdatedSendMessageHandler;
            }

            if ((SendMessageEvents & MessageType.PointersPressed) != 0) {
                Instance.PointersPressed += pointersPressedSendMessageHandler;
            }

            if ((SendMessageEvents & MessageType.PointersReleased) != 0) {
                Instance.PointersReleased += pointersReleasedSendMessageHandler;
            }

            if ((SendMessageEvents & MessageType.PointersRemoved) != 0) {
                Instance.PointersRemoved += pointersRemovedSendMessageHandler;
            }

            if ((SendMessageEvents & MessageType.PointersCancelled) != 0) {
