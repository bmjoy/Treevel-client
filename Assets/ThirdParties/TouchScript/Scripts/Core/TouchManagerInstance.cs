...
namespace TouchScript.Core
{
    ...
    public sealed class TouchManagerInstance : DebuggableMonoBehaviour, ITouchManager
    {
        ...
        {
            add {
                pointersCancelledInvoker += value;
            }
            remove {
                pointersCancelledInvoker -= value;
            }
        ...
        {
            get {
                return new List<IInputSource>(inputs);
            }
        }
        ...
        {
            get {
                return new List<Pointer>(pointers);
            }
        }
        ...
        {
            get {
                return new List<Pointer>(pressedPointers);
            }
        }

        /// <inheritdoc />
        public bool IsInsidePointerFrame
        {
            get;
            private set;
        }
        ...
        private void createInput()
        {
            if (inputCount == 0 && shouldCreateStandardInput) {
                ...
                if (objects.Length == 0) {
                    ...
                    if (obj == null) {
                        obj = new GameObject("TouchScript");
                    }
                } else {
