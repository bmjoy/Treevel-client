...
namespace TouchScript
{
    ...
    public interface ITouchManager
    {
        ...
        bool ShouldCreateStandardInput {
            get;
            set;
        }
