...
namespace TouchScript.Behaviors
{
    ...
    public class Transformer : MonoBehaviour
    {
        ...
        {
            get {
                return smoothingFactor * 100000f;
            }
            set {
        ...
        {
            get {
                return Mathf.Sqrt(positionThreshold);
            }
            set {
                positionThreshold = value * value;
            }
        }
        ...
        {
            get {
                return Mathf.Sqrt(scaleThreshold);
            }
            set {
        ...
        {
            get {
                return allowChangingFromOutside;
            }
            set {
                allowChangingFromOutside = value;
            }
        }
        ...
        private void stateAutomatic()
        {
            ...
            if (!enableSmoothing || transformMask == TransformGesture.TransformType.None) {
                stateIdle();
            }
        }
        ...
        private void update()
        {
            if (state == TransformerState.Idle) {
                return;
            }
            ...
            if ((transformMask & TransformGesture.TransformType.Scaling) != 0) {
                ...
                if (state == TransformerState.Automatic && !changed && (targetScale - lastScale).sqrMagnitude > scaleThreshold) {
                    changed = true;
                }
            }
        ...
        {
            if (state != TransformerState.Manual) {
                stateManual();
            }
