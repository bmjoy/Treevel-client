...
namespace Project.Scripts.StageSelectScene
{
	public class HardStageSelectDirector : StageSelectDirector
	{
		protected override void MakeButtons()
		{
			...
			for (var i = 0; i < StageInfo.Num[EStageLevel.Hard]; i++)
			{
				// ステージを一意に定めるID
				var stageId = StageInfo.StageStartId[EStageLevel.Hard] + i;
				// ボタンインスタンスを生成
				...
				// Buttonの色
				button.GetComponent<Image>().color = new Color(1.0f, 0.50f, 0.50f);
				// Buttonの位置
