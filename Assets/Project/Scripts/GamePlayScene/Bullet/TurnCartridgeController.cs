    ...
    public class TurnCartridgeController : NormalCartridgeController
    {
        ...
        protected override void FixedUpdate()
        {
            ...
            // 回転はじめのフレーム
                ...
                Destroy(warning);
                rotateCount++;
                motionVector = MyVector2.Rotate(motionVector, turnAngle / 2f);
            ...
            // 回転中のフレーム
                ...
                rotateCount++;
                motionVector = MyVector2.Rotate(motionVector, turnAngle);
            ...
            // 回転おわりのフレーム
                ...
                if (turnDirection.Length >= 2) {
                    ...
                    turnPoint = transform.position * MyVector2.Abs(MyVector2.Transposition(motionVector)) + new Vector2(
                                    TileSize.WIDTH * (turnLine[0] - 2),
                                    WindowSize.HEIGHT * 0.5f - (TileSize.MARGIN_TOP + TileSize.HEIGHT * 0.5f) -
                                    TileSize.HEIGHT * (turnLine[0] - 1)) * MyVector2.Abs(motionVector);
